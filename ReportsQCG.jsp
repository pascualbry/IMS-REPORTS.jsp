...
<head>
  ...
  <script type="text/javascript" src="https://cdn.fusioncharts.com/fusioncharts/latest/themes/fusioncharts.theme.fusion.js"></script>
	...
	<script src="/Inventory/Js/jspdf.js"></script>
	<script src="/Inventory/Js/jquery-2.1.3.js"></script>
	<script src="/Inventory/Js/pdfFromHTML.js">
	function HTMLtoPDF(){
...
<div class="navbar">
  ...
  <ul>
    <li class="unactive">
      <a href="/IMS/DASHBOARD/DashboardQCG.jsp">
      <div class="icon">
...
<div class="ex2">
 <table cellspacing="0" cellpadding="0" border="0">
  <tr>
    <td>
       <div style="width:1050px; height:260px; overflow:auto;">
...
%>	
	...
	<tr>
		...
		<td style="width: 18.29%;">P<%=obj_Variable_Product.getDateReceive() %></td>
		<td style="width: 14.29%;"><%=obj_Variable_Product.getName() %></td>
		<td style="width: 12.29%;"><%=obj_Variable_Product.getQuantity() %></td>
		<td style="width: 12.29%;"><%=obj_Variable_Product.getPrice() %></td>
