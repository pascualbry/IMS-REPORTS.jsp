 ...
 <table cellspacing="0" cellpadding="0" border="0">
  <tr>
    <td>
      ...
      <tr>
        <th onclick="sortTable(0)" style="width: 12.67%">Order Number</th>
 ...
 <table cellspacing="0" cellpadding="0" border="0">
  <tr>
    <td>
      ...
      <tr>
        <th onclick="sortTable(0)" style="width: 8.29%;">Order Number</th>
...
%>	
	...
	<tr>
		...
		<td style="width: 8.29%;"><a>031720<%=obj_Variable_Product.getTag() %></a></td>
...
%>	
	...
	<tr>
		...
		<td><a>031720<%=obj_Variable_Order.getTag() %></a></td>
